...
public class CantidadPrintDialog extends OcultarTeclado {
    ...
    public CantidadPrintDialog(Context contexcto , finalizarCuadro actividad){
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    if(a.isEmpty()){
                        ...
                        float valor =Float.parseFloat(edt_numero.getText().toString());

                        if (valor<1000&&valor>0){

                            dialogo.dismiss();
                            interfaz.ResultadoCantidadDialogo(valor);

                        }else{
                            Toast.makeText(contexcto,"Valor incorrecto",Toast.LENGTH_SHORT).show();
                        }
